...
static const std::vector<QPen> plotPens{ QPen(Qt::gray, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin), QPen(Qt::magenta, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin), QPen(Qt::blue, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin), QPen(Qt::black, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin), QPen(Qt::red, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin) };
