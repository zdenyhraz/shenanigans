		...
		else
		{
			...
			else
			{
				...
				for ( int i = 0; i < maxPCit; i++ )
				{
					...
					if ( set.IPCshow ) LOG_DEBUG( "L1peak findCentroid double delta: " + to_string( findCentroidDouble( L1 ).x - L1mid.x ) + " , " + to_string( findCentroidDouble(
						                                  L1 ).y - L1mid.y ) );
			...
			if ( set.IPCshow ) LOG_DEBUG( "L3 size: " + to_string( L3.cols ) + ", L2 size: " + to_string( L2.cols ) + ", L2U size: " + to_string( L2U.cols ) + ", L1 size: " + to_string(
				                                  L1.cols ) );
