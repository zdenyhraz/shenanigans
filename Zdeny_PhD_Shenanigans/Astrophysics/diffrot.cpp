...
DiffrotResults calculateDiffrotProfile( const IPCsettings &ipcset, FitsTime &time, const DiffrotSettings &drset )
{
	...
	auto ycoeffsPoly = polyfitCoeffs( thetasavg, omegasYavg, 3 );
	logFitCoeffs( xcoeffsPoly, xcoeffsTrig, ycoeffsPoly );

	DiffrotResults dr;
	dr.SetData1D( thetasavg, omegasXavg, omegasYavg, omegasXavgpolyfit, omegasYavgpolyfit, shiftsXavg, shiftsYavg );
