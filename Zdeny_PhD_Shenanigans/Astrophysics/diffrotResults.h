...
public:
	void ShowResults( int medianSize, double sigma, double quanBot = 0, double quanTop = 1 )
	{
		...
		Plot1D::plot( ThetasNS, std::vector<std::vector<double>> {polyfit( OmegasYavgN, 3 ), polyfit( OmegasYavgS, 3 ), OmegasYavgN, OmegasYavgS}, "diffrot profile NS Y", "absolute solar latitude [deg]", "absolute vertical material flow speed [deg/day]", std::vector<std::string> {"polyfit3 North", "polyfit3 South", "average North", "average South" }, std::vector<QPen> { QPen( Plot::blue, 3 ), QPen( Plot::black, 3 ), QPen( Plot::blue, 1.5 ), QPen( Plot::black, 1.5 )}, saveDir + "1DNSYs" + to_string( SourceStride ) + ".png" );
		...
		Plot1D::plot( ThetasNScut, std::vector<std::vector<double>> {polyfit( OmegasYavgNcut, 3 ), polyfit( OmegasYavgScut, 3 ), OmegasYavgNcut, OmegasYavgScut}, "diffrot profile NS cut Y", "absolute solar latitude [deg]", "absolute vertical material flow speed [deg/day]", std::vector<std::string> {"polyfit3 North", "polyfit3 South", "average North", "average South" }, std::vector<QPen> { QPen( Plot::blue, 3 ), QPen( Plot::black, 3 ), QPen( Plot::blue, 1.5 ), QPen( Plot::black, 1.5 )}, saveDir + "1DNScYs" + to_string( SourceStride ) + ".png" );
