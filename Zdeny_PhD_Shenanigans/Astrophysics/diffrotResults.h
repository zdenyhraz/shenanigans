...
public:
	void ShowResults( int medianSize, double sigma, double quanBot = 0, double quanTop = 1 )
	{
		...
		// diffrot profiles
		Plot1D::plot( SourceThetasavg, std::vector<std::vector<double>> {SourceOmegasXavgpolyfit, SourceOmegasXavg, PredicXs[0], PredicXs[1]}, "diffrot profile X", "solar latitude [deg]", "horizontal material flow speed [deg/day]", std::vector<std::string> {"polyfit2", "average", "Derek A. Lamb (2017)", "Howard et al. (1983)"}, std::vector<QPen> { QPen( Plot::red, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::blue, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::orange, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::magenta, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin )}, saveDir + "1DXs" + to_string( SourceStride ) + ".png" );
		Plot1D::plot( SourceThetasavg, std::vector<std::vector<double>> {SourceOmegasYavgpolyfit, SourceOmegasYavg }, "diffrot profile Y", "solar latitude [deg]", "vertical material flow speed [deg/day]", std::vector<std::string> {"polyfit3", "average" }, std::vector<QPen> { QPen( Plot::red, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::blue, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin )}, saveDir + "1DYs" + to_string( SourceStride ) + ".png" ); //rgb(119, 136, 153)

		// diffrot profiles NS
		Plot1D::plot( ThetasNS, std::vector<std::vector<double>> {polyfit( OmegasXavgN, 2 ), polyfit( OmegasXavgS, 2 ), OmegasXavgN, OmegasXavgS, PredicXsNS[0], PredicXsNS[1]}, "diffrot profile NS X", "absolute solar latitude [deg]", "horizontal material flow speed [deg/day]", std::vector<std::string> {"polyfit2 North", "polyfit2 South", "average North", "average South", "Derek A. Lamb (2017)", "Howard et al. (1983)" }, std::vector<QPen> { QPen( Plot::blue, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::black, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::blue, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::black, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::orange, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::magenta, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin )}, saveDir + "1DNSXs" + to_string( SourceStride ) + ".png" );
		Plot1D::plot( ThetasNS, std::vector<std::vector<double>> {polyfit( OmegasYavgN, 3 ), polyfit( OmegasYavgS, 3 ), OmegasYavgN, OmegasYavgS}, "diffrot profile NS Y", "absolute solar latitude [deg]", "absolute vertical material flow speed [deg/day]", std::vector<std::string> {"polyfit3 North", "polyfit3 South", "average North", "average South" }, std::vector<QPen> { QPen( Plot::blue, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::black, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::blue, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::black, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin )}, saveDir + "1DNSYs" + to_string( SourceStride ) + ".png" );

		// diffrot profiles NS cut
		Plot1D::plot( ThetasNScut, std::vector<std::vector<double>> {polyfit( OmegasXavgNcut, 2 ), polyfit( OmegasXavgScut, 2 ), OmegasXavgNcut, OmegasXavgScut, PredicXsNScut[0], PredicXsNScut[1]}, "diffrot profile NS cut X", "absolute solar latitude [deg]", "horizontal material flow speed [deg/day]", std::vector<std::string> {"polyfit2 North", "polyfit2 South", "average North", "average South", "Derek A. Lamb (2017)", "Howard et al. (1983)" }, std::vector<QPen> { QPen( Plot::blue, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::black, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::blue, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::black, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::orange, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::magenta, 2, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin )}, saveDir + "1DNScXs" + to_string( SourceStride ) + ".png" );
		Plot1D::plot( ThetasNScut, std::vector<std::vector<double>> {polyfit( OmegasYavgNcut, 3 ), polyfit( OmegasYavgScut, 3 ), OmegasYavgNcut, OmegasYavgScut}, "diffrot profile NS cut Y", "absolute solar latitude [deg]", "absolute vertical material flow speed [deg/day]", std::vector<std::string> {"polyfit3 North", "polyfit3 South", "average North", "average South" }, std::vector<QPen> { QPen( Plot::blue, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::black, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::blue, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::black, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin )}, saveDir + "1DNScYs" + to_string( SourceStride ) + ".png" );

		// shifts profiles
		Plot1D::plot( SourceThetasavg, std::vector<std::vector<double>> {polyfit( SourceThetasavg, SourceShiftsXavg, 2 ), SourceShiftsXavg, ShiftsXErrorsBot, ShiftsXErrorsTop}, "shifts profile X", "solar latitude [deg]", "horizontal image shift [px]", std::vector<std::string> {"polyfit2", "average", "average - stdev", "average + stdev"}, std::vector<QPen> { QPen( Plot::red, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::blue, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::orange, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::magenta, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin )}, saveDir + "1DsXs" + to_string( SourceStride ) + ".png" );
		Plot1D::plot( SourceThetasavg, std::vector<std::vector<double>> {polyfit( SourceThetasavg, SourceShiftsYavg, 3 ), SourceShiftsYavg, ShiftsYErrorsBot, ShiftsYErrorsTop}, "shifts profile Y", "solar latitude [deg]", "vertical image shift [px]", std::vector<std::string> {"polyfit3", "average", "average - stdev", "average + stdev"}, std::vector<QPen> { QPen( Plot::red, 3, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::blue, 1.5, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::orange, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Plot::magenta, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin )}, saveDir + "1DsYs" + to_string( SourceStride ) + ".png" );
