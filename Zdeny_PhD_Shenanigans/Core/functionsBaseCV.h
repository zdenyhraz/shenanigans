...
Mat applyQuantile( const Mat &sourceimgIn, double quantileB = 0, double quantileT = 1 );

Mat applyQuantileColorMap( const Mat &sourceimgIn, double quantileB = 0, double quantileT = 1 );
