...
{
  if (x - w / 2 < 0 || y - h / 2 < 0 || x + w / 2 > sourceimgIn.cols || y + h / 2 > sourceimgIn.rows)
  {
    LOG_ERROR("Roicrop out of bounds! image: [{}x{}], crop: [{}x{}], cropmid: [{}x{}]", sourceimgIn.cols, sourceimgIn.rows, w, h, x, y);
