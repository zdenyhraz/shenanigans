...
public:
	...
	{
		return plot( matToVect2( z ), name, "x", "y", name );
	}

	static void plot( const Mat &z, std::string name, std::string xlabel, std::string ylabel, std::string zlabel, double xmin = 0, double xmax = 1, double ymin = 0, double ymax = 1, std::string savepath = "" )
	{
