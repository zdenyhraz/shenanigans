...
static const std::vector<QPen> plotPens{ QPen( Qt::gray, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Qt::blue, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ), QPen( Qt::red, 1, Qt::SolidLine, Qt::RoundCap, Qt::RoundJoin ) };
