...
public:
	...
	{
		return plotcore( x, std::vector<double> {y}, emptyvect, name, xlabel, ylabel, emptystring, emptyvectstring, emptyvectstring, savepath );
	}
	...
	{
		return plotcore( x, std::vector<double> {y1}, std::vector<double> {y2}, name, xlabel, y1label, y2label, std::vector<std::string> {y1label}, std::vector<std::string> {y2label}, savepath );
	}
	...
	{
		return plotcore( x, ys, emptyvect, name, xlabel, ylabel, emptystring, ynames, emptyvectstring, savepath );
	}
	...
	{
		return plotcore( x, y1s, y2s, name, xlabel, y1label, y2label, y1names, y2names, savepath );
	}
	...
	static void plot( const std::vector<double> &y, std::string name, std::string xlabel = "x", std::string ylabel = "y", std::string savepath = emptystring )
	{
		...
		return plotcore( x, std::vector<std::vector<double>> {y}, emptyvect2, name, xlabel, ylabel, emptystring, emptyvectstring, emptyvectstring, savepath );
	}
	...
	{
		return plotcore( x, std::vector<std::vector<double>> {y1}, std::vector<std::vector<double>> {y2}, name, xlabel, y1label, y2label, std::vector<std::string> {y1label}, std::vector<std::string> {y2label}, savepath );
	}
	...
	{
		return plotcore( x, ys, emptyvect2, name, xlabel, ylabel, emptystring, ynames, emptyvectstring, savepath );
	}
	...
	// add data core
	static void plotcore( double x, const std::vector<double> &y1s, const std::vector<double> &y2s, std::string name, std::string xlabel = "x", std::string y1label = "y1", std::string y2label = "y2", std::vector<std::string> y1names = emptyvectstring, std::vector<std::string> y2names = emptyvectstring, std::string savepath = emptystring );
