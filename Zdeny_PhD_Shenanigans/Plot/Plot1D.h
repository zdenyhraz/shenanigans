...
public:
	...
	// x - y add data
	static void plot( double x, double y, std::string name, std::string xlabel = "x", std::string ylabel = "y", std::vector<QPen> pens = Plot::defaultpens, std::string savepath = emptystring )
	{
	...
	// x - y1/y2 add data
	static void plot( double x, double y1, double y2, std::string name, std::string xlabel = "x", std::string y1label = "y1", std::string y2label = "y2", std::vector<QPen> pens = Plot::defaultpens, std::string savepath = emptystring )
	{
	...
	// x - ys add data
	static void plot( double x, const std::vector<double> &ys, std::string name, std::string xlabel = "x", std::string ylabel = "y", std::vector<std::string> ynames = emptyvectstring, std::vector<QPen> pens = Plot::defaultpens, std::string savepath = emptystring )
	{
	...
	// x - y replot data
	static void plot( const std::vector<double> &x, const std::vector<double> &y, std::string name, std::string xlabel = "x", std::string ylabel = "y", std::vector<QPen> pens = Plot::defaultpens, std::string savepath = emptystring )
	{
		return plotcore( x, std::vector<std::vector<double>> {y}, emptyvect2, name, xlabel, ylabel, emptystring, emptyvectstring, emptyvectstring, pens, savepath );
	}

	// x - y1/y2 replot data
	static void plot( const std::vector<double> &x, const std::vector<double> &y1, const std::vector<double> &y2, std::string name, std::string xlabel = "x", std::string y1label = "y1", std::string y2label = "y1", std::vector<QPen> pens = Plot::defaultpens, std::string savepath = emptystring )
	{
	...
	// x - ys replot data
	static void plot( const std::vector<double> &x, const std::vector<std::vector<double>> &ys, std::string name, std::string xlabel = "x", std::string ylabel = "y", std::vector<std::string> ynames = emptyvectstring, std::vector<QPen> pens = Plot::defaultpens, std::string savepath = emptystring )
	{
