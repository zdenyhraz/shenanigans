...
void calculateDiffrotProfile(const IPCsettings& IPC_settings, const IPCsettings& IPC_settings1, const IPCsettings& IPC_settings2, FITStime& FITS_time, DiffrotResults* MainResults, int iters, int itersX, int itersY, int medianiters, int strajdPic, int deltaPic, int verticalFov, int deltasec, string pathMasterOut, Logger* logger, AbstractPlot1D* plot);
