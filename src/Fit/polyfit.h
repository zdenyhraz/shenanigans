...
inline cv::Mat polyfitcore2d( const std::vector<double> &xdata, const std::vector<double> &ydata, const std::vector<double> &zdata, int degree, double xmin, double xmax, double ymin, double ymax, double xcnt, double ycnt )
{
	int datacnt = ydata.size();
...
inline cv::Mat polyfit( const std::vector<double> &xdata, const std::vector<double> &ydata, const std::vector<double> &zdata, int degree, double xmin, double xmax, double ymin, double ymax, double xcnt, double ycnt )
{
